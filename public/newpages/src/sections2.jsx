...
const { Arrow: A2, ArrowUpRight: AUR, SvcIcon } = window.UI;
    ...
    <section id="about" className="section-pad" data-screen-label="05 About">
      <div className="container">
        <div className="about-grid">
          <div className="about-img" style={{ backgroundImage: `url(${window.IMG.aboutMain})` }}>
          ...
          <div className="about-copy">
            ...
            <div style={{display:"flex", gap:14, flexWrap:"wrap"}}>
              <a href="#" className="btn btn-dark">Learn More About Us <A2/></a>
              <a href="#" className="btn btn-ghost">Download Company Profile <AUR/></a>
            </div>
            <div className="sig">
...
function Projects() {
  const projects = [
    { cat: "Building Construction", title: "14-Storey Commercial Tower, Gulshan", size: "82,000 sqft", img: window.IMG.proj1, tall: true, num: "P·001" },
    { cat: "Road Works", title: "District Highway Upgrade, Cumilla", size: "24 KM", img: window.IMG.proj2, num: "P·002" },
    { cat: "Bridge & Culvert", title: "Girder Bridge, Padma Feeder Route", size: "180 m span", img: window.IMG.proj3, num: "P·003" },
    { cat: "Site Development", title: "Industrial Park Earthworks, Mymensingh", size: "120 acres", img: window.IMG.proj4, num: "P·004" },
    { cat: "Structural Concrete", title: "RCC Framework, EPZ Warehouse Facility", size: "45,000 sqft", img: window.IMG.proj5, num: "P·005" },
    { cat: "Foundation Work", title: "Deep Pile Foundation, Riverside Development", size: "340 piles", img: window.IMG.proj6, num: "P·006" },
  ];
  return (
    <section className="section-pad section-soft" data-screen-label="06 Projects">
      <div className="container">
        ...
        <div className="projects-grid">
          {projects.map((p, i) => (
            <article key={p.title} className={`project ${p.tall ? "tall" : ""}`}>
        ...
        <div style={{display:"flex", justifyContent:"center", marginTop: 50}}>
          <a href="Projects.html" className="btn btn-dark">View All Projects <A2/></a>
        </div>
      </div>
    </section>
  );
        ...
        <div className="network-grid">
          {concerns.map(c => (
            <div key={c.logo} className="concern">
              ...
              <a href="#" className="exp-link" style={{fontSize:11}}>Visit Concern <A2 size={12}/></a>
            </div>
          ))}
        </div>
      </div>
...
Object.assign(window, { About, Projects, Services, Network, Certifications });
