...
const IMG = {
  ...
  heroBridge:    "https://images.unsplash.com/photo-1590856029826-c7a73142bbf1?w=2000&q=80&auto=format&fit=crop",
  expGov:        "https://images.unsplash.com/photo-1590644365607-1c9c3f380cd7?w=1000&q=80&auto=format&fit=crop",
  expCom:        "https://images.unsplash.com/photo-1577495508048-b635879837f1?w=1000&q=80&auto=format&fit=crop",
  expPriv:       "https://images.unsplash.com/photo-1605276374104-dee2a0ed3cd6?w=1000&q=80&auto=format&fit=crop",
  aboutMain:     "https://images.unsplash.com/photo-1581094794329-c8112a89af12?w=1200&q=80&auto=format&fit=crop",
  proj1:         "https://images.unsplash.com/photo-1517089596392-fb9a9033e05b?w=1200&q=80&auto=format&fit=crop",
  proj2:         "https://images.unsplash.com/photo-1621352452648-c717c4eba35f?w=1200&q=80&auto=format&fit=crop",
  proj3:         "https://images.unsplash.com/photo-1508450859948-4e04fabaa4ea?w=1200&q=80&auto=format&fit=crop",
  proj4:         "https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=1200&q=80&auto=format&fit=crop",
  proj5:         "https://images.unsplash.com/photo-1565008576549-57569a49371c?w=1200&q=80&auto=format&fit=crop",
  proj6:         "https://images.unsplash.com/photo-1518335935020-cfd6580c1ab4?w=1200&q=80&auto=format&fit=crop",
  ctaBanner:     "https://images.unsplash.com/photo-1590644875981-3b4dbbd8b8ac?w=2000&q=80&auto=format&fit=crop",
  insight1:      "https://images.unsplash.com/photo-1587582140428-8f3bc86c4a63?w=800&q=80&auto=format&fit=crop",
  insight2:      "https://images.unsplash.com/photo-1521618755572-156ae0cdd74d?w=800&q=80&auto=format&fit=crop",
  insight3:      "https://images.unsplash.com/photo-1590644776933-e05027243a9d?w=800&q=80&auto=format&fit=crop",
  insight4:      "https://images.unsplash.com/photo-1521791136064-7986c2920216?w=800&q=80&auto=format&fit=crop",
};
window.IMG = IMG;
...
function Nav({ scrolled }) {
  ...
  const currentFile = (typeof location !== "undefined" ? location.pathname.split("/").pop() : "") || "Zakir Enterprise.html";
    ...
    <nav className={`nav ${scrolled ? "scrolled" : ""}`}>
      <div className="nav-inner">
        ...
        <ul className="nav-menu">
          {items.map((it) => {
            const active = (decoded === "Projects.html" && it.label === "Projects") ||
                           (decoded !== "Projects.html" && it.label === "Home");
            return (
              <li key={it.label}><a href={it.href} className={active ? "active" : ""}>{it.label}</a></li>
            );
          })}
        </ul>
...
function Hero({ variant }) {
  const bg = variant === "crane" ? IMG.heroCrane
           : variant === "bridge" ? IMG.heroBridge
           : IMG.heroSkyline;
  return (
    <section className="hero" data-screen-label="01 Hero">
      ...
      <div className="container hero-inner">
        ...
        <p className="lede">
          Zakir Enterprise delivers reliable construction solutions across Bangladesh —
      ...
      <div className="container">
        <div className="section-head">
          ...
          <p className="head-right">
            From government infrastructure to private developments, we operate with the same
            discipline, safety standards and delivery confidence on every site.
          </p>
        </div>
        <div className="expertise-grid">
          {cards.map(c => (
            <article key={c.title} className="exp-card">
              <div className="exp-img" style={{ backgroundImage: `url(${c.img})` }}>
                <span className="exp-tag">{c.tag}</span>
              </div>
              <div className="exp-body">
                <h3>{c.title}</h3>
                <p>{c.body}</p>
                <a href="#" className="exp-link">Explore Sector <Arrow/></a>
              </div>
            </article>
          ))}
        </div>
        ...
        <div className="stats">
          {stats.map(s => (
            <div key={s.label} className="stat">
              <div className="stat-num"><Counter to={s.n}/>{s.plus && <span className="plus">{s.plus}</span>}</div>
